...
:checksummarypath2
if exist D:\Program\POCB_%Lineno%_%Machineno%_AIM (goto :SetSummarypath2) else (goto :checksummarypath2_4041)
:checksummarypath2_4041
if exist D:\Program\POCB_%Lineno%_%Machineno% (goto :setsummarypath2_4041) else (goto :checksummarypath3_1)
:checksummarypath3_1
...
:checkmlogpath2
if exist D:\Program\POCB_%Lineno%_%Machineno%_AIM\Log\M_LOG (goto :Setmlogpath2) else (goto :checkmlogpath2_4041)
:checkmlogpath2_4041
if exist D:\Program\POCB_%Lineno%_%Machineno%\Log\M_LOG (goto :setmlogpath2_4041) else (goto :checkmlogpath3_1)
:checkmlogpath3_1
