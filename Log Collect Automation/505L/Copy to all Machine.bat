...
xcopy "Demura to Main %lineno%L %monocolor% #%machineno%.bat" "\\%ip%\Program\RVS" /C /Q /Y /I
xcopy "%lineno%L %monocolor% #%machineno% log collect scheduler.xml" "\\%ip%\Program\RVS" /C /Q /Y /I
set /A machineno+=1
goto :copy
